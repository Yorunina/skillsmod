...
public class ConnectionBatchedRenderer {
	...
	public void draw() {
		...
		BufferRenderer.drawWithShader(bufferBuilderOutline.end());
		RenderSystem.setShaderColor(1f, 1f, 1f, 1f);
		BufferRenderer.drawWithShader(bufferBuilderNormal.end());
		RenderSystem.setShaderColor(1f, 0f, 0f, 1f);
		BufferRenderer.drawWithShader(bufferBuilderExclusive.end());
